...
<body onload="window.print(); self.close();">
	...
	<!--		<tr>-->
	<!--			<th style="color : black;"><?= $trx['nama_kasir'] ?><br>-->
	...
	<!--		</tr>-->
	<!--		<tr>-->
	<!--			<td style="color : black;">#<?= $trx['nomor'] ?> | <?= date('d-m-Y', strtotime($trx['tanggal_waktu'])) ?> <?= date('H:i:s', strtotime($trx['waktu'])) ?> <?= $trx['nama_kasir'] ?></td>-->
	...
	<!--		<tr>-->
	<!--			<td style="color : black;" align="right" colspan="3">Total</td>-->
	<!--			<td style="color : black;" align="right"><?= number_format($trx['total']) ?></td>-->
	<!--		</tr>-->
	<!--		<tr>-->
	<!--			<td style="color : black;" align="right" colspan="3">Bayar</td>-->
	<!--			<td style="color : black;" align="right"><?= number_format($trx['bayar']) ?></td>-->
	<!--		</tr>-->
	<!--		<tr>-->
	<!--			<td style="color : black;" align="right" colspan="3">Kembali</td>-->
	<!--			<td style="color : black;" align="right"><?= number_format($trx['kembali']) ?></td>-->
	...
	<!--		</tr>-->
	<!--		<tr>-->
	<!--			<th style="color : black;">Terimkasih, Selamat Belanja Kembali</th>-->
	<!--		</tr>-->
	<!--		<tr>-->
	<!--			<th style="color : black;">===== Layanan Konsumen ====</th>-->
	<!--		</tr>-->
